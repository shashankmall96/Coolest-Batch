...
addBtn.addEventListener("click", function () {
  ...
  //  earlier addTaskFlag has been assigned as False so that modal cont box is not available on screen
  // !addTaskFlag = True , so when we click for the first time it opens the modal box , on 2nd click it hides
  ...
  toolboxColors[i].addEventListener("click", function () {
    ...
    filteredTickets.forEach(function (filterdTicket) {
      createTicket(
        ...
        filterdTicket.ticketColorClass,
...
function createTicket(ticketTask, ticketColorClass, ticketID) {
  ...
  //once the ticket is generated , remove modal container box
  modalCont.style.display = "none";
